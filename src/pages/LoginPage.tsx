...
const LoginPage = () => {
  ...
  const loginUrl = `https://accounts.google.com/o/oauth2/v2/auth?client_id=${googleClientId}&redirect_uri=${redirectUri}&response_type=code&scope=openid%20email%20profile&prompt=select_account`

  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/10 via-white to-primary/5">
      <div className="card max-w-md w-full mx-4 text-center space-y-8 animate-fade-in">
        ...
        <div>
          ...
          <p className="text-gray-600">Create short links with powerful analytics</p>
        </div>

        <div className="space-y-4">
          <a href={loginUrl} className="btn-primary block">
